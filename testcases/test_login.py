...
class Test_Login(base_test):
    ...
    def test_login_with_valid_authentication(self, username, password):
        ...
        home.login(user_name=username, pass_word=password)
        vendor_tool.tap_vendor_tool('manager')

        user_first_name = (data_access.DataAccessObject.get_user_information(username))
